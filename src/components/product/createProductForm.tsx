...
import {
    ImageUploadField,
    uploadableFile
} from "../fileUpload/ImageUploadField";
import { Image, Product, useCreateProductMutation, useMeQuery } from "../../generated/graphql";
import theme from "../../theme";
import { clean } from "../../utils/clean";
import DisplayModal, { modalProps } from "../../utils/DisplayModal";
...
export const CreateProductForm: React.FC<props> = ({ item }) => {
  useIsAuth();
  ...
  const [modalSettings, setModal] = useState<modalProps>({
    ...
    const initialValues: Values = {
        ...
        productAvailableTo: item?.productAvailableTo || '',
        productAvailableFrom: item?.productAvailableFrom || '',
